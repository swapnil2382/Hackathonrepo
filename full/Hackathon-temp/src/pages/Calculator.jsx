...
const Calculator = () => {
    ...
    const handleEstimate = (e) => {
        ...
        const profitData = estimateProfit(type, parseFloat(amount), parseFloat(rate), parseFloat(years));
    ...
    const handleBuy = () => {
        ...
        if (balance >= amt) {
            ...
            setHoldings([...holdings, { type, amount: amt }]);
        } else {
    ...
    const handleSell = (index) => {
        const asset = holdings[index];
        setBalance(balance + asset.amount);
        ...
        <div style={styles.container}>
            ...
            <div style={styles.box}>
                ...
                <form onSubmit={handleEstimate}>
                    ...
                    <button type="submit" style={styles.button}>Estimate Profit</button>
                    <button type="button" style={styles.button} onClick={handleBuy}>Buy</button>
                </form>
            ...
            <div style={styles.box}>
                {result && (
                    <div style={styles.section}>
                        ...
                        <p><strong>Adjusted Rate:</strong> {result.adjustedRate}%</p>
                ...
                <div style={styles.section}>
                    ...
                    {holdings.length === 0 ? (
                        ...
                        holdings.map((asset, index) => (
                            <div key={index}>
                                <p>{asset.type.toUpperCase()} - ${asset.amount.toFixed(2)}</p>
